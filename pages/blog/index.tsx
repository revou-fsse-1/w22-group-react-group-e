          ...
          >
            ...
            <div className="w-full p-4 bg-white sm:p-6">
              ...
              <Link href={`/blog/${post.slug.current}`}>
                <h3 className="mt-0.5 text-blue-950 text-2xl font-semibold capitalize">
                  {post.title}
                </h3>
              </Link>
              <p className="py-3 mt-2 text-gray-500 line-clamp-3 text-sm/relaxed">
                {post.overview}
              </p>
              <Link
                className="text-[#548776] py-[24px] text-base font-bold capitalize leading-loose"
