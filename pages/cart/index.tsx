  ...
  return (
    <div className="max-w-5xl p-8 mx-auto">
      ...
      <div className="w-full h-[190px] relative">
        ...
        <div className="left-[699px] top-[98px] absolute text-slate-900 text-lg font-semibold capitalize">
          Rp. 1000
        </div>
        ...
        <div className="w-[135px] h-[30px] px-[7px] left-[186px] top-[98px] absolute border border-neutral-300 justify-center items-center gap-[18px] inline-flex">
          ...
          <div>
            <span className="text-xl font-medium capitalize text-slate-900">
              1{' '}
            </span>
        ...
        <div className="left-[186px] top-[32px] absolute text-slate-900 text-[15px] font-medium capitalize">
          Tumis Kangkung
        </div>
